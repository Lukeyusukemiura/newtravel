...
<template>
  <div class="body-bg" style="font-family: 'Lato', sans-serif">
    <header class="max-w-lg mx-auto">
      <a href="#">
        <h1 class="text-4xl font-bold text-white text-center">Pegasus</h1>
      </a>
    </header>
    ...
    >
      <section>
        <h3 class="font-bold text-2xl">Welcome to Pegasus</h3>
