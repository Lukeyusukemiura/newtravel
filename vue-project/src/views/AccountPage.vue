...
<template>
  ...
  >
    <div>
      <div
        class="top-box text-white h-96 w-full bg-cover bg-center p-24 flex-column justify-center items-center"
      >
        <h1 class="font-bold text-5xl mb-3">Yusuke Miura</h1>
        <div>
          A travel enthusiast trying to find out what ethnography can offer to
          the world
        </div>
      </div>
    </div>
    ...
    <section class="bg-white py-8">
      <div class="container py-8 px-6 mx-auto">
        ...
        <p class="mt-8 mb-8">
          I'm a travel enthusiast trynna find out what ethnography could offer
          to this world
          <br />
        </p>
      </div>
        ...
        <div class="w-full mx-auto flex flex-wrap">
          <div class="flex w-full lg:w-1/2">
            <div class="px-3 md:px-0">
              <h3 class="font-bold text-gray-900">Social links</h3>
              <p class="py-4">
                <a href="#"></a>
              </p>
            </div>
