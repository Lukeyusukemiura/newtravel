...
let headerHeightStyle = ref<string>("13.6419vh");
let pageHeightStyle = ref<string>("86.3581vh");
// onMounted(() => {
...
//   console.log(pageHeightStyle.value);
...
<template>
  <div>
    <HeaderCommon ref="headerRef" :style="{ height: headerHeightStyle }" />
